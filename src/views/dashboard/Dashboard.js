              ...
              <table className="table table-hover table-outline mb-0 d-none d-sm-table">
                ...
                <tbody>
                    ...
                    <td>
                      <div className="clearfix">
                        ...
                        <div className="float-right">
                          <small className="text-muted">Jan 05, 2021 - Current</small>
                        </div>
                      </div>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <div className="small text-muted">
                        ...
                        <span>Recurring</span> | Jan 05, 2021 - Current
                      </div>
                    </td>
                    <td className="text-center">
                  ...
                  <tr>
                    <td className="text-center">
                      <div className="c-avatar">
                        <img src={'avatars/3.jpg'} className="c-avatar-img" alt="admin@connectex.com" />
                        <span className="c-avatar-status bg-warning"></span>
                      </div>
                    </td>
                    <td>
                      <div>Kaynaat Fatima</div>
                      <div className="small text-muted">
                        <span>New</span> | Jan 05, 2021 - Current
                      </div>
                    </td>
                    <td className="text-center">
